...
public class UserController {
    ...
    @Autowired
    private UserService userService; //userService gestione oggetti user
    ...
    public String registration(Model model) { //gestione utente
        //Complete the method
        User user = new User();
    ...
    public String registerUser(User user) {
        //Complete the method
        userService.registerUser(user); //delega alla classe userService la registrazione utente
        return "users/login";
    }
